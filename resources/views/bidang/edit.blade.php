...
=======
                        <div class="form-group{{ $errors->has('kuota') ? ' has-error' : '' }}">
                            <label for="soal" class="col-md-4 control-label">Kuota Siswa</label>
                            <div class="col-md-6">
                                <input type="number" name="kuota" class="form-control" value="{{ $data->kuota}}">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="email" class="col-md-12 control-label">Cover Paket Belajar</label>
>>>>>>> 2ae6383a7487ee6ced6ed1bcc9a14f250f7ca53e
                            <div class="col-md-6">
