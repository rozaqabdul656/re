                      ...
                      @foreach($datas as $data)
                        <tr>
                          ...
                          <td class="text-center">
                              ...
                              <button type="submit" class="btn btn-xs btn-info" ><i class="fa fa-edit"></i> Edit</button></a>

                              <a href="{{url('delete-bidang',$data->id_bidang)}}">
            
                              <button type="submit" class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash"></i> Hapus</button></a>
