...
Route::get('/rangkuman-detail/{datas}','rangkumanController@detail');
...
Route::get('/rangkuman-daftar-grup','rangkumanController@daftar_rangkuman_upload');
...
Route::get('/kick-peserta/{bidang}/{data}','soalController@kick');
Route::get('/kick-peserta2/{bidang}/{data}','soalController@kick2');

Auth::routes();

Route::get('/home', 'HomeController@index')->name('home');

Route::get('/nilai_to','toController@tampilnilai');
Route::get('/nilai-detail/{data}','toController@tampilnilaidetail');
